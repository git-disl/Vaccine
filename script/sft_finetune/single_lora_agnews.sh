...
CUDA_VISIBLE_DEVICES=0 python train.py \
	...
	--bf16 True \
	--output_dir ckpt/ag_news/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}_singlelora \
	--num_train_epochs 20 \
...
CUDA_VISIBLE_DEVICES=0 python pred.py \
	--lora_folder ../../ckpt/ag_news/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}_singlelora \
	--model_folder ${model_path} \
	--output_path ../../data/poison/ag_news/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}_singlelora


CUDA_VISIBLE_DEVICES=0 python eval_sentiment.py \
	--input_path ../../data/poison/ag_news/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}_singlelora
...
CUDA_VISIBLE_DEVICES=0 python pred_eval.py   \
	--lora_folder ../ckpt/ag_news/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}_singlelora  \
	--model_folder ${model_path} \
	--output_path ../data/ag_news/${path_after_slash}_sft_f_${poison_ratio}_${sample_num}_singlelora

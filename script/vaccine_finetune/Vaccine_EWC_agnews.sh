...
#SBATCH -o vaccine_EWC_ag_news-%j.out                         # Combined output and error messages file
...
CUDA_VISIBLE_DEVICES=0 python pred.py \
	--lora_folder ../../ckpt/${path_after_slash}_vaccine_${RHO} \
	--lora_folder2 ../../ckpt/ag_news/${path_after_slash}_vaccine_f_${RHO}_${poison_ratio}_${sample_num}_${lamb} \
	--model_folder ${model_path} \
